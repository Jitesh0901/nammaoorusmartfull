...
try {
  const mappings = {
    "public/ASSETS/Water_Purifier_a":
      "src/assets/images/products/water-purifiers",
    "public/ASSETS/Water_Softener_b":
      "src/assets/images/products/water-softeners",
  ...
  const logoSrc = fs.existsSync("public/logo_new.png")
    ? "public/logo_new.png"
    : fs.existsSync("public/logo.png")
      ? "public/logo.png"
      : null;
